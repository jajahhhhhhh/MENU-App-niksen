...
const update = db.prepare(`
  UPDATE menu_items SET name_th=@th, name_ru=@ru, description=@desc, description_th=@desc_th, description_ru=@desc_ru, image_url=COALESCE(@image, image_url), available=1 WHERE id=@id
`);
