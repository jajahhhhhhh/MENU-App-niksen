...
export const LANDING: Record<Lang, LandingStrings> = {
  en: {
    ...
    heroHours: 'Open daily from 7:00',
    heroCta: 'Order online',
    heroCta2: 'Find us',
    heroCardLabel: 'niksen secret bar',
    heroCardHours: 'Every day · from 7:00',
    ...
    visitHours: 'Every day · from 7:00 till late',
  ...
  th: {
    ...
    heroHours: 'เปิดทุกวัน ตั้งแต่ 7:00',
    heroCta: 'สั่งออนไลน์',
    heroCta2: 'ดูที่ตั้ง',
    heroCardLabel: 'niksen secret bar',
    heroCardHours: 'ทุกวัน · ตั้งแต่ 7:00',
    ...
    visitHours: 'ทุกวัน · ตั้งแต่ 7:00 จนดึก',
  ...
  ru: {
    ...
    heroHours: 'Каждый день с 7:00',
    heroCta: 'Заказать',
    heroCta2: 'Как нас найти',
    heroCardLabel: 'niksen secret bar',
    heroCardHours: 'Каждый день · с 7:00',
    ...
    visitHours: 'Каждый день · с 7:00 до позднего вечера',
